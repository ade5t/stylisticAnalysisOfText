...
>>> import sys
>>> sys.path.insert(0, llib>>> import _socket
>>> print(_socket)
<module '_socket' from 'lib1.zilibocket.pyd'>
>>> _socket.__file__
'lib1.zilibsocket.pyd'
>>> _socket.__loader__
<ZipExtensionImporter object 'lib1.zilib>>> # Reloading also works correctly:
